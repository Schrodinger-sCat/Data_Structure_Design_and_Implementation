public class Assignment01{
  public static void main(String[]args){
    ...
    System.out.println("\nTest 05");
    Object[] a9={10,20,30,40,50,60,null,null};
    Object[] a10={20,10,30,40,50,10,null,null};
    CircularArray c9=new CircularArray(a9,2,6);
    CircularArray c10=new CircularArray(a10,1,6);
    c9.print();
    System.out.println(c9.sortCheck());
    c10.print();
    System.out.println(c10.sortCheck());
    
    System.out.println("\nTest 06");
    Object[] a11={10,20,30,40,50,60,null,null};
    Object[] a12={20,10,30,40,50,10,null,null};
    CircularArray c11=new CircularArray(a11,2,6);
    CircularArray c12=new CircularArray(a12,1,6);
    c11.print();
    System.out.println(c11.sortCheck(1,4));
    c12.print();
    System.out.println(c12.sortCheck(1,4));
  }
}